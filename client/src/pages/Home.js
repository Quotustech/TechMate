...
const Home = () => {
  ...
  const onSubmit = () => {
    ...
    if (!inputValue) {
      ...
      setIsListenung(false);
      axios
        .post(url, { message: inputValue, userId: "64e4504fbaccdd7f23bb7d29" })
        .then((res) => {
              ...
              {responceData === null ? (
                <>
                  ...
                  <h2 className="text-2xl font-serif text-white p-4 m-5 mt-8 md:mt-16">
                    Whether you're on the verge of launching your practical AI
                    application or exploring groundbreaking AI technologies, our
                    logo maker will help supercharge your brand. Find
                    inspiration and craft the perfect, professional logo to
                    represent your AI business—in just a few clicks.
                  </h2>
                </>
              ) : (
              ...
              <div className="flex items-center p-5 mt-10">
                ...
                <div className="relative w-full">
                  ...
                  {isListening === false ? (
                    ...
                    >
                      <svg
                        className="w-4 h-4 text-red-500 dark:text-red-400 hover:text-red-900 dark:hover:text-white"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 16 20"
